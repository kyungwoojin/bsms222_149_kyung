title: "Chapter 5 Importing data"
...
```{r}
filepath<-file.path('C:/Users/woojin/Documents', 'temperature.csv')
dat3<-read.csv(filepath)
plot(dat3, x= as.factor(dat3$date),y=dat3$temp)
```
