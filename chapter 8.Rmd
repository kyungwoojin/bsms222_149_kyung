...
![firstimage](https://rafalab.github.io/dsbook/book_files/figure-html/state-region-distribution-1.png)
...
![secondimage](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-1.png)
...
$(49.5,50.5], (50.5,51.5],(51.5,52.5],(52.5,53.5], ...,(82.5,83]$

![thirdimage](https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-1.png)
...
![fourthimage](https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-1.png)
...
![fifthimage](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-1-1.png)
The smaller we make the bins, the smoother the histogram gets. Here are the histograms with bin width of 1, 0.5, and 0.1:

![sixthimage](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-2-1.png)
...
![seventhimage](https://rafalab.github.io/dsbook/book_files/figure-html/simulated-density-1-1.png)
...
![eigthimage](https://rafalab.github.io/dsbook/book_files/figure-html/smooth-density-2-1.png)
...
![ninthimage](https://rafalab.github.io/dsbook/book_files/figure-html/densities-different-smoothness-1.png)
...
![tenthimage](https://rafalab.github.io/dsbook/book_files/figure-html/area-under-curve-1.png)
...
![eleventhimage](https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-2-1.png)
...
![twelfthimage](https://rafalab.github.io/dsbook/book_files/figure-html/two-densities-one-plot-1.png)
...
![thirteenthimage](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-exercise-1.png)
...
![fourteenthimage](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-1.png)
...
![fifteenthiamge](https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-2-1.png)
...
![sixteenthimage](https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-exercise-1.png)
...
![seventeenthimage](https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-1.png)
a. 0.02
b. 0.15
c. 0.50
d. 0.55
...
![eighteenthimage](https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-2-1.png)
...
![nineteenthimage](https://rafalab.github.io/dsbook/book_files/figure-html/normal-distribution-density-1.png)
...
![twentiethimage](https://rafalab.github.io/dsbook/book_files/figure-html/data-and-normal-densities-1.png)
...
So about 50% are shorter or equal to 69 inches. This implies that if $ㅔ=0.50$ then $q=69.5$
...
2. Define a vector of quantiles $q_1,...,q_m$ for your data for your data for the proportions $p_1,...,p_m$. We refer to these as the *sample quantiles*.
3. Define a vector of theoretical quantiles for the proportions $p_1,..,p_m$ for a normal distribution with the same average and standard deviation as the data.
...
mp <- qnorm(p, mean=mean(male), sd=sd(male))
fp <- qnorm(p, mean=mean(female), sd=sd(female))
data.frame(percentiles=c('10th','30th','50th','70th','90th'),male_percentiles=mp, female_percentiles=fp)
```
...
```{r}
a<- mean(x>79 & x<=81)
b<- pnorm(81,mean(x),sd(x))-pnorm(79,mean(x),sd(x))
a/b
#> 1.6 times bigger
```
